...
final phraseProvider = ChangeNotifierProvider<PhrasesProviderNotifier>((ref) {
  return PhrasesProviderNotifier();
});

class PhrasesProviderNotifier extends ChangeNotifier {
