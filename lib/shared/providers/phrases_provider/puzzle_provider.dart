...
import 'package:flutter_puzzle_hack_riverpod/data/models/location.dart';
import 'package:flutter_puzzle_hack_riverpod/data/models/puzzle.dart';
import 'package:flutter_puzzle_hack_riverpod/data/models/score.dart';
...
final puzzleProvider = ChangeNotifierProvider<PuzzleProviderNotifier>((ref) {
  return PuzzleProviderNotifier(ref.read(storageProvider))..generate();
});

class PuzzleProviderNotifier extends ChangeNotifier {
  final IStorageService storageService;

  PuzzleProviderNotifier(this.storageService);
  ...
  void swapTilesAndUpdatePuzzle(Tile tile) {
    ...
    Logger.log(
        "movedTileIndex $movedTileIndex whiteSpaceTileIndex $whiteSpaceTileIndex movedTile $movedTile whiteSpaceTile $whiteSpaceTile");
